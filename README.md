...
- **Game Management**: 전역 페이즈 및 게임 상태 제어를 위한 중앙 관리 시스템 구축
- **Interaction System**: 상호작용(Lift&Drop) 로직 설계
- **Tutorial System**: 유저 조작 유도 및 단계별 가이드를 위한 튜토리얼 시퀀스 개발
- **Scene Flow Control**: 씬 전환 및 시퀀스 연출의 순차적 흐름을 제어하는 컨트롤러 설계
